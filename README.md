...
Install version `v0.1.6` from GitHub:

```sh
go install github.com/vichr-vita/goralph@v0.1.6
goralph --help
```

Remote `go install` needs a version suffix such as `@v0.1.6`.
...
Update installed binary to `v0.1.6`:
